...
local atisZones = {
    ["Andoya"] = {airbaseName = AIRBASE.Kola.Andoya},
    ["Bodo"] = {airbaseName = AIRBASE.Kola.Bodo},
    ["Kiruna"] = {airbaseName = AIRBASE.Kola.Kiruna},
    ["Jokkmokk"] = {airbaseName = AIRBASE.Kola.Jokkmokk},
    ["Vidsel"] = {airbaseName = AIRBASE.Kola.Vidsel},
    ["Kallax"] = {airbaseName = AIRBASE.Kola.Kallax},
    ["Kirkenes"] = {airbaseName = AIRBASE.Kola.Kirkenes},
    ["KemiTornio"] = {airbaseName=AIRBASE.Kola.Kemi_Tornio,runways={["00"]="36"}},
    ["Rovaniemi"] = {airbaseName = AIRBASE.Kola.Rovaniemi},
    ["Vuojarvi"] = {airbaseName = AIRBASE.Kola.Vuojarvi},
    ["Banak"] = {airbaseName = AIRBASE.Kola.Banak},
    ["Monchegorsk"] = {airbaseName = AIRBASE.Kola.Monchegorsk},
    ["Olenya"] = {airbaseName = AIRBASE.Kola.Olenya},
    ["MurmanskInternational"] = {airbaseName = AIRBASE.Kola.Murmansk_International},
    ["Severomorsk-3"] = {airbaseName = AIRBASE.Kola.Severomorsk_3},
    ["Severomorsk-1"] = {airbaseName = AIRBASE.Kola.Severomorsk_1},
    ["Kuusamo"] = {airbaseName = AIRBASE.Kola.Kuusamo},
    ["Ivalo"] = {airbaseName = AIRBASE.Kola.Ivalo},
    ["Alakourtti"] = {airbaseName = AIRBASE.Kola.Alakurtti},
    ["Bardufoss"] = {airbaseName = AIRBASE.Kola.Bardufoss},
    ["Kittila"] = {airbaseName = AIRBASE.Kola.Kittila}

}
local atisZoneNames = {}
allZones = {
    "Andoya", "Bodo", "BergsBasen", "Kvikkjokk", "Skogsbasen", "Kiruna", "Jokkmokk", "Luspa", 
    "Vidsel", "Kallax", "SAMAlvik", "Kirkenes", "KemiTornio", "Rovaniemi", "Vuojarvi", 'Bardufoss', 'Kittila',
    "Banak", "Monchegorsk", "Olenya", "MurmanskInternational", "Severomorsk-3", "Severomorsk-1", 
    "Kuusamo", "Gallivare", "Savukoski", "Kovdor", "Ivalo", "Karasjok", "Guovdageaidnu", 
    "Apatity", "Zapolyarnyy", "Alakourtti", "Prirechnyi", 'Kelloselka', 'Buolbmat', 'Maaninkavaara', 'Tervola',
	'SkogsFARP1', 'SkogsFARP2', 'SkogsFARP3', 'SkogsFARP4', 'Savukoski', 'Kalix'
}
airbaseStatics = {
