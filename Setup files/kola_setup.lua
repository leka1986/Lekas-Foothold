...
upgrades = {
    ...
    gadzhiyevospawn = {
        blue = {'blueInfantry'},
        red = {'Red SAM AAA','Red SAM SHORAD SA-15', 'Red SAM SHORAD SA-15','Gadzhiyevo workshop','Gadzhiyevo ammo depot'}
    },
    ...
    HiddenScatteredEWR = {
        blue = {},
        red = {'Red EWR Scattered Fixed 1','Red EWR Scattered Fixed 2','Red EWR Scattered Fixed 3','Red EWR Scattered Fixed 4','Red EWR Scattered Fixed 5','Red EWR Scattered Fixed 6'}
    }
}
...
local vnSwap = {
    ...
    ['Grisha'] = 'FacLa',
    ['Murmansk-naval-group-Fixed-red'] = 'Murmansk-naval-group-Fixed-red-Vietnam',
    ['Murmansk-naval-group-Fixed-red-Coldwar'] = 'Murmansk-naval-group-Fixed-red-Vietnam',
    ['Severomorsk-naval-group-Fixed-red'] = 'Severomorsk-naval-group-Fixed-red-Vietnam',
    ['Severomorsk-naval-group-Fixed-red-coldwar'] = 'Severomorsk-naval-group-Fixed-red-Vietnam',
...
RandomUpgradeTemplates = {
    ...
    smallsam = { sam = 1, shorad = {0,2}, aaa = {0,2}, ground = {0,3}, armor = {0,3}, arty = {0,2}, total = {4,6}, flakChance = 12, flakSecondChance = 0, flakMax = 1, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 20, ["Red SAM SHORAD Tor M2"] = 20 } },
    ...
    mediumsam = { sam = 1, shorad = {0,3}, aaa = {0,3}, ground = {0,3}, armor = {0,3}, arty = {0,3}, total = {5,9}, flakChance = 15, flakSecondChance = 0, flakMax = 1, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 50, ["Red SAM SHORAD Tor M2"] = 50 } },
    ...
    bigsam = { sam = 1, shorad = {0,4}, aaa = {0,3}, ground = {0,2}, armor = {0,2}, arty = {0,2}, total = {5,9}, flakChance = 35, flakSecondChance = 8, flakMax = 2, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 60, ["Red SAM SHORAD Tor M2"] = 60 } },
    ...
    sam = { sam = 1, shorad = {1,2}, aaa = {1,2}, ground = 0, armor = 0, arty = 0, total = {3,5}, flakChance = 10, flakSecondChance = 0, flakMax = 1, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 60, ["Red SAM SHORAD Tor M2"] = 60 } },
    shorad = { sam = 0, shorad = {1,2}, aaa = {1,2}, ground = 0, armor = 0, arty = 0, total = {2,4}, flakChance = 10, flakSecondChance = 0, flakMax = 1, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 0, ["Red SAM SHORAD Tor M2"] = 0 } },
    shoradsmall = { sam = 0, shorad = 2, aaa = 0, ground = 0, armor = 0, arty = 0, total = 2, flakChance = 10, flakSecondChance = 0, flakMax = 1 },
    armor4 = { sam = 0, shorad = 0, aaa = 0, ground = 0, armor = 4, arty = 0, total = 4, flakChance = 0, flakSecondChance = 0, flakMax = 0 },
    armor3shorad1 = { sam = 0, shorad = 1, aaa = 0, ground = 0, armor = 3, arty = 0, total = 4, flakChance = 0, flakSecondChance = 0, flakMax = 0, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 0, ["Red SAM SHORAD Tor M2"] = 0 } },
    HiddenVesivoimala = { sam = 0, shorad = 0, aaa = 1, ground = 0, armor = {1,2}, arty = 0, total = {2,3}, flakChance = 0, flakSecondChance = 0, flakMax = 0 },
    ...
    HiddenTungozero = { sam = 1, shorad = {1,2}, RandomRedPickKeepChance = { ["Red SAM SHORAD Pantsir S1"] = 0, ["Red SAM SHORAD Tor M2"] = 0 } },
}
...
local footholdSaveEraBaseName = (Era == 'Vietnam') and 'FootHold_KO_Vietnam_v0.4' or ((Era == 'Coldwar') and 'FootHold_KO_ColdWar_v0.4' or 'FootHold_KO_Modern_v0.4')
FootholdSaveBaseName = footholdSaveEraBaseName .. ((CustomFlags['DynCampaign'] == true) and '_mission' or '')
...
TheaterAreas = {
	{
		...
		zones = {
			...
			{ name = "Alta", role = "approach" },
			{ name = "Banak", role = "gateway" },
			{ name = "Buolbmat", role = "gateway" },
			{ name = "BergsBasen", role = "support" },
		},
	},
	{
		id = "western_lapland",
		...
		zones = {
			...
			{ name = "Karasjok", role = "gateway" },
			{ name = "Kvikkjokk", role = "approach" },
			{ name = "Skogsbasen", role = "support" },
			{ name = "Gallivare", role = "gateway" },
			{ name = "Kalixfors", role = "support" },
			{ name = "Jokkmokk", role = "hub" },
			{ name = "Vidsel", role = "hub" },
		},
	},
	{
		...
		zones = {
			...
			{ name = "KemiTornio", role = "hub" },
			{ name = "Tervola", role = "gateway" },
			{ name = "Rovaniemi", role = "hub" },
		},
	},
	{
		id = "finnish_lapland",
	...
	},
	{
		...
		zones = {
			...
			{ name = "Prirechnyi", role = "support" },
			{ name = "Severomorsk1", role = "hub" },
		},
	},
	{
		id = "kola_air_network",
		...
		zones = {
			...
			{ name = "Olenya", role = "hub" },
			{ name = "Monchegorsk", role = "hub" },
			{ name = "Apatity", role = "gateway" },
			{ name = "LaplandiyaStorage", role = "resource" },
			{ name = "ZelenoborskijStorage", role = "resource" },
			{ name = "LovozeroCCC", role = "resource" },
			{ name = "GadzhiyevoShipYard", role = "resource" },
			{ name = "KoashvaStorage", role = "resource" },
			{ name = "AfrikandaStorage", role = "resource" },
			{ name = "KilpYavrStorage", role = "resource" },
			{ name = "PyaozerskyStorage", role = "resource" },
		},
	},
}
...
StrategicBomber.Configure({
	...
	[2] = {
		...
		recoveryMinRunwayLengthMeters = 1957,
...
mc:trackMission({
    ...
    endAction = function()
		bc:cancelGroupTargetMission('scuds2', 2)
    end,
	isActive = function()
...
mc:trackMission({
    ...
    endAction = function()
		bc:cancelGroupTargetMission('scuds1', 2)
    end,
	isActive = function()
...
function checkZoneFlags()
    ...
    supplypenalty = 0
    if zones.apatity.side ~= 2 or zones.kovdor.side ~= 2 then
...
if not zones.hiddenKemiRoadblock.firstCaptureByRed and zones.kemitornio.side == 2 then
