...
-- This script needs cuople of things, Static unit called EventMan and the carrier named CVN-72 AND CVN-73 on some maps.
...
local atisZones = {
	...
	["El Gora"]						        = { airbaseName = AIRBASE.Sinai.El_Gora },
	["El Arish"]						    = { airbaseName = AIRBASE.Sinai.El_Arish },
	["Kom Awshim"]					        = { airbaseName = AIRBASE.Sinai.Kom_Awshim },
	["Birma Air Base"]					    = { airbaseName = AIRBASE.Sinai.Birma_Air_Base },
	["Gebel El Basur Air Base"]			    = { airbaseName = AIRBASE.Sinai.Gebel_El_Basur_Air_Base },
	["Kibrit Air Base"]					    = { airbaseName = AIRBASE.Sinai.Kibrit_Air_Base },
	["Borg El Arab International Airport"]	= { airbaseName = AIRBASE.Sinai.Borj_El_Arab_International_Airport },
	["Jiyanklis Air Base"]				    = { airbaseName = AIRBASE.Sinai.Jiyanklis_Air_Base },
	["Hatzor"]				                = { airbaseName = AIRBASE.Sinai.Hatzor },
}
...
allZones = {
    ...
    "Sde Dov", "Palmahim", "Tel Nof", "Hatzor", "Kedem-Hatzerim", "Nevatim", "El Gora", "El Arish", "Bir Hasanah", 
	"Baluza", "As Salihiyah", "Al Ismailiyah", "Kibrit Air Base", "Al Mansurah", "AzZaqaziq", "Inshas Airbase", 
	"Cairo International Airport", "Cairo West", "FARP-Alpha","FARP-Bravo", "FARP-Charlie",
	"Gebel El Basur Air Base", "Birma Air Base", "Kom Awshim", "Beni Suef", "Jiyanklis Air Base", "Borg El Arab International Airport"
}
airbaseStatics = {
