...
local atisZones = {
    ["Ben-Gurion"] = {airbaseName = AIRBASE.Sinai.Ben_Gurion},
    ["Ramon Airbase"] = {airbaseName = AIRBASE.Sinai.Ramon_Airbase},
    ["Ovda"] = {airbaseName = AIRBASE.Sinai.Ovda},
    ["Melez"] = {airbaseName = AIRBASE.Sinai.Melez},
    ["Wadi al Jandali"] = {airbaseName = AIRBASE.Sinai.Wadi_al_Jandali},
	["Kedem-Hatzerim"] = {airbaseName = AIRBASE.Sinai.Hatzerim},
	["Nevatim"] = {airbaseName = AIRBASE.Sinai.Nevatim},
	["St Catherine"] = {airbaseName = AIRBASE.Sinai.St_Catherine},
	["Al Mansurah"] = {airbaseName = AIRBASE.Sinai.Al_Mansurah},
	["As Salihiyah"] = {airbaseName = AIRBASE.Sinai.As_Salihiyah},
	["Al Ismailiyah"] = {airbaseName = AIRBASE.Sinai.Al_Ismailiyah},
	["Abu Suwayr"] = {airbaseName = AIRBASE.Sinai.Abu_Suwayr},
	["AzZaqaziq"] = {airbaseName = AIRBASE.Sinai.AzZaqaziq},
	["Sharm El Sheikh International Airport"] = {airbaseName = AIRBASE.Sinai.Sharm_El_Sheikh_International_Airport},
	["Hurghada International Airport"] = {airbaseName = AIRBASE.Sinai.Hurghada_International_Airport},
	["Beni Suef"] = {airbaseName = AIRBASE.Sinai.Beni_Suef},
	["Kom Awshim"] = {airbaseName = AIRBASE.Sinai.Kom_Awshim},
	["Birma Air Base"] = {airbaseName = AIRBASE.Sinai.Birma_Air_Base},
	["Quwaysina"] = {airbaseName = AIRBASE.Sinai.Quwaysina},
    ["Kibrit Air Base"] = {airbaseName = AIRBASE.Sinai.Kibrit_Air_Base}

}
local atisZoneNames = {
    ["Hatzerim"] = {airbaseName = AIRBASE.Sinai.Hatzerim},
    ["Kedem"]  = {airbaseName = AIRBASE.Sinai.Kedem},

    }

-- Define all zones
allZones = {
    "Ben-Gurion", "Ramon Airbase", "Red Carrier", "Blue Carrier", "Ovda", "Melez", "Wadi al Jandali",
    "Sde Dov", "Palmahim", "Tel Nof", "Hatzor", "Kedem-Hatzerim", "Nevatim", "El Gora", "El Arish",
    "St Catherine", "Abu Rudeis", "Bir Hasanah", "Baluza", "As Salihiyah", "Al Ismailiyah", "Abu Suwayr",
    "Difarsuwar Airfield", "Fayed", "Kibrit Air Base", "Al Mansurah", "AzZaqaziq", "Bilbeis Air Base",
    "Inshas Airbase", "Cairo International Airport", "Cairo West", "FARP-Alpha", "FARP-Bravo", "FARP-Charlie",
    "FARP-Delta", "FARP-Echo", "FARP-Foxtrot", "FARP-Golf", "FARP-Hotel", "FARP-India", "FARP-Juliett",
    "FARP-Kilo", "FARP-Lima", "FARP-Mike", "Quwaysina", "Birma Air Base", "Kom Awshim", 
	"Beni Suef", "Hurghada International Airport", "Sharm El Sheikh International Airport"
}
