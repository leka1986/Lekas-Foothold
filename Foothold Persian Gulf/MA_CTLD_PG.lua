...
if lfs then
if Era == 'Coldwar' then  
FarpFileName = "Foothold_PG_CTLD_FARPS_Coldwar.csv"
else
FarpFileName = "Foothold_PG_CTLD_FARPS_Modern.csv"
end
...
if Era =='Coldwar' then
Foothold_ctld.filename = "FootHold_PG_CTLD_Save_Coldwar.csv" -- example filename
else
Foothold_ctld.filename = "FootHold_PG_CTLD_Save_Modern.csv" -- example filename
end
