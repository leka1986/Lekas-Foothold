...
local atisZones = {
    ["Bashur Airport"] 			= {airbaseName = AIRBASE.Iraq.Bashur_Airport},
    ["Erbil Airport"] 				= {airbaseName = AIRBASE.Iraq.Erbil_International_Airport},
    ["Qayyarah Airfield"] 			= {airbaseName = AIRBASE.Iraq.Qayyarah_Airfield_West},
    ["Kirkuk City"] 				= {airbaseName = AIRBASE.Iraq.Kirkuk_International_Airport},
    ["Sulaimaniyah Airport"] 		= {airbaseName = AIRBASE.Iraq.Sulaimaniyah_International_Airport},
    ["Al-Sahra Airport"] 			= {airbaseName = AIRBASE.Iraq.Al_Sahra_Airport},
    ["Balad Airbase"] 				= {airbaseName = AIRBASE.Iraq.Balad_Airbase},
    ["Al-Salam Airbase"] 			= {airbaseName = AIRBASE.Iraq.Al_Salam_Airbase},
    ["Al-Asad Airbase"] 			= {airbaseName = AIRBASE.Iraq.Al_Asad_Airbase},
    ["Mosul City"] 			        = {airbaseName = AIRBASE.Iraq.Mosul_International_Airport},
}
...
-- Define all zones
allZones = {
    "Bashur Airport", "Erbil Airport", "Mosul City", "Hammam Al Alil", "Duhok City",
    "Tal Afar", "Al Tall", "Qayyarah Airfield", "Al Abbasi", "Kirkuk City",
    "Sulaimaniyah Airport", "Said Sadiq", "Al-Sahra Airport", "Barzan", "Chamanki",
    "OutPost", "Maydan", "Sarqala", "Khormato", "Balad Airbase",
    "Al-Salam Airbase", "Fallujah", "Ramadi", "Al-Asad Airbase",
    "FOB Samarra", "FOB Therethar", "Koya", "Dukan", "Sangasar"
}
airbaseStatics = {
